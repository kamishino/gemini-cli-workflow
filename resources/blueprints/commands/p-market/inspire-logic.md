...
Create a Discovery file in `{{KAMI_WORKSPACE}}ideas/discovery/` with a Hash ID.
...
## 3. OUTPUT FORMAT
"🚀 Innovation Sparked! ID: [ID] | File: {{KAMI_WORKSPACE}}ideas/discovery/[ID]_[slug]_ai-discovery.md"
