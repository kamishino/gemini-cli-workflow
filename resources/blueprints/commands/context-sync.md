...
1. **PRESERVE conversational memory.** Your conversation history IS the most current context — it may contain decisions, refinements, and context that disk files do NOT yet reflect.
