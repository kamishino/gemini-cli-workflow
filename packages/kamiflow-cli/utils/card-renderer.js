...
class CardRenderer {
  ...
  renderCard(data, options = {}) {
    ...
    output +=
      chalkColor(
        this.chars.topLeft +
          ...
          this.chars.horizontal.repeat(Math.max(0, headerRepetition)) +
          this.chars.topRight,
      ) + "\n";
    ...
    if (label) {
      ...
      output +=
        chalkColor(this.chars.vertical) +
        " ".repeat(padding) +
        chalk.bgWhite.black(label) +
        " ".repeat(Math.max(0, labelRepetition)) +
        " ".repeat(padding) +
        chalkColor(this.chars.vertical) +
        "\n";
    }
    ...
    output +=
      ...
      " ".repeat(padding) +
      chalk.dim(pathLine) +
      " ".repeat(Math.max(0, pathPaddingNeeded)) +
      " ".repeat(padding) +
      chalkColor(this.chars.vertical) +
      "\n";
    ...
    output +=
      chalkColor(
        this.chars.bottomLeft +
          this.chars.horizontal.repeat(cardWidth - 2) +
