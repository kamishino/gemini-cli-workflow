...
- Reproducible failures where root cause is unknown.
- Regressions after refactors, upgrades, or config changes.
- Issues needing minimal-risk fixes plus regression tests.
