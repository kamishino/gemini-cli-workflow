...
- Early discovery when problem framing is still fuzzy.
- Before `/develop` or `/kamiflow` to improve option quality.
- When you need a ranked shortlist instead of immediate implementation.
...
Phase 3: Rate          -> Impact x Feasibility x Effort, Kill < 8
