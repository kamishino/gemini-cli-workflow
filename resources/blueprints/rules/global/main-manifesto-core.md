---
name: main-manifesto-core
type: RULE
description: Core values and non-negotiables for KamiFlow
group: global
order: 10
---
...
- **Validator Loop:** Follow `{{KAMI_RULES_GEMINI}}flow-execution-core.md` for self-healing execution.

## 4. 🥋 PHILOSOPHICAL GUIDE (Shu-Ha-Ri)
