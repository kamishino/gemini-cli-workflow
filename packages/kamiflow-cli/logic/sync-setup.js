...
async function guidedCloudflareSetup() {
  ...
  console.log(
    chalk.gray("   See: packages/kamiflow-cli/docs/sync/backend/README.md#cloudflare\n"),
  );
...
async function guidedSelfHostedSetup() {
  ...
  console.log(
    chalk.gray("   See: packages/kamiflow-cli/docs/sync/backend/README.md#self-hosted\n"),
  );
  console.log("3. Return here and run:");
  console.log(chalk.cyan("   kami sync-db setup\n"));
}
