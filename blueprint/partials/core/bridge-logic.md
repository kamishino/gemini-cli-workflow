...
Use `write_file` to create `tasks/[ID]-S4-HANDOFF-[slug].md`.
...
## 2. Source of Truth 📖
- **BUILD Plan:** tasks/[ID]-S3-BUILD-[slug].md
- **Specification:** tasks/[ID]-S2-SPEC-[slug].md
...
## 4. Immediate Action ⚡
Please execute the implementation tasks in: `tasks/[ID]-S3-BUILD-[slug].md`.

## 5. 📚 Documentation Contract
You MUST update these files upon completion:
- `PROJECT_CONTEXT.md` (Active Status)
- `docs/ROADMAP.md` (Check off tasks)
...
## 4. INTERACTION RULES
- After generating, ask: "Do you want me to save this to `tasks/[ID]-S4-HANDOFF-[slug].md`? (Y/N)"
