...
2. **Check Analysis Status:**
   - ✅ **Analysis Complete:** Feasibility and Risk scores present
   - ⚠️ **Analysis Failed:** Log error, skip to next file
   - 🔄 **Hallucination Risk Detected:** Mark as "Needs Manual Review"
...
{{#each needs_review}}
- [ID]: [Title]
  → Reason: [Low feasibility / High risk / Hallucination risk]
  → Action: Review manually, improve, or discard
{{/each}}
```
