...
3. Check if `PROJECT_CONTEXT.md` exists and is not empty.
...
- If user confirms, prompt: "File saved! Next: `/kamiflow:core:bridge tasks/[ID]-S3-BUILD-[slug].md` to handoff to IDE."
