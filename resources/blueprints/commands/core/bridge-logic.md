...
2. **Technical Constraints:**
   - Rules from `manifesto.md` and `tech-stack.md`
...
**BEFORE marking work complete, execute validation from `@.gemini/rules/flow-validation.md`:**
...
**Reference:** See `@.gemini/rules/flow-reflection.md` for full template.
