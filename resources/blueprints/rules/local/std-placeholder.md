---
name: Infrastructure Placeholder Standard
type: rule
description: Best practice for using standardized placeholders in blueprints to ensure environment agility.
group: local
order: 10
---
...
### ❌ WRONG (Anchored Path)
`Follow instructions in @./.gemini/rules/std-id.md`
`Update file at ./.kamiflow/PROJECT_CONTEXT.md`

### ✅ CORRECT (Standard Tokens)
`Follow instructions in {{KAMI_RULES_GEMINI}}std-id.md`
