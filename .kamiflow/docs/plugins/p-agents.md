...
3.  **🤝 Handshake:** The system updates `./.kamiflow/universal-agent-rules.md`. Copy this file's content to your IDE's specific rules file (e.g., `.cursorrules`) to finalize the integration.
...
The bridge maintains a central source of truth for agent behavior at `./.kamiflow/universal-agent-rules.md`. This ensures that whether you are using Windsurf or Cursor, the AI follows the same **KamiFlow Manifesto**.
