...
**MANDATORY:** You MUST read the `PROJECT_CONTEXT.md` and the input `S1-IDEA` file. 
...
- If user confirms, prompt: "File saved! Next: `/kamiflow:core:build tasks/[ID]-S2-SPEC-[slug].md` to plan the implementation."
