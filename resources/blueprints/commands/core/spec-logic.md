...
`read_file {{KAMI_RULES_GEMINI}}g-spec.md`
BEFORE generating the S2-SPEC artifact. The detailed Data Models and Test Specification in the Guide are non-negotiable.
