...
// 2. IDE Metadata (real-time)
{
  ...
  cursorLine: 1,
  openDocuments: [
    "packages/kamiflow-cli/docs/overview.md",
...
1. Files: _.js, _.md, \*.json (from user message)
...
Extracted: - Intent: MODIFY (refactor) - File: auth.js - Function: handleUserAuth - Technology: JWT - Action: Use different authentication method
```
