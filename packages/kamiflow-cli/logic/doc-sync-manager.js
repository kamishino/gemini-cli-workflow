...
class DocSyncManager {
  constructor(projectRoot = process.cwd()) {
    ...
    this.wikiFiles = {
      sniper: path.join(projectRoot, "packages/kamiflow-cli/docs/commands/core.md"),
      bridge: path.join(projectRoot, "packages/kamiflow-cli/docs/commands/core.md"),
      autopilot: path.join(projectRoot, "packages/kamiflow-cli/docs/commands/dev.md"),
      ops: path.join(projectRoot, "packages/kamiflow-cli/docs/commands/ops.md"),
      terminal: path.join(projectRoot, "packages/kamiflow-cli/docs/commands/terminal.md"),
      global: path.join(projectRoot, "packages/kamiflow-cli/docs/commands/README.md"),
    };
  ...
  async sync() {
    try {
      ...
      const targetMap = [
        ...
        {
          file: path.join(this.projectRoot, "resources/blueprints/templates/gemini.md"),
          groups: finalOrder,
        },
        {
          file: path.join(this.projectRoot, "packages/kamiflow-cli/docs/overview.md"),
          groups: finalOrder,
        },
      ];
