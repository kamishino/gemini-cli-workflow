...
> Run these before marking any task complete or committing code.

| Action                  | Command                                                                                                  |
| :---------------------- | :------------------------------------------------------------------------------------------------------- |
| **Run all tests**       | `node --test packages/antigravity-kit/test/scaffold.test.js packages/antigravity-kit/test/suite.test.js` |
| **Scaffold tests only** | `node --test packages/antigravity-kit/test/scaffold.test.js`                                             |
| **Suite tests only**    | `node --test packages/antigravity-kit/test/suite.test.js`                                                |

**Rule:** Never tag a release without 15/15 tests passing.
...
_Auto-generated by Self-Correcting Constitution Protocol (Task 127)_
